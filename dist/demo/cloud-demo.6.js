...
//// Register 'oomfoo', an A-Frame component version of Oom.Dd.
...
Vue.component('oom-demo', {
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Dd.
...
//// Register <a-oomfoo-wrap>, to tell Vue about the A-Frame primative for Oom.Dd.
...
//// Register <oom-base-sub>, a Vue component version of Oom.Dd.Cloud.
Vue.component('oom-base-sub', {
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Dd.Cloud.
  , beforeCreate: function () {
        inners.push( new ROOT.Oom.Dd.Cloud({
